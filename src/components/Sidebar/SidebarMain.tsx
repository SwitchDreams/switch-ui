...
const SidebarMain = ({ mobileLogo, children, className, ...rest }: SidebarVariant) => {
  ...
  return (
    <>
      ...
      <div
        className={twMerge(
          style,
          "absolute top-0 z-10 h-full border-r border-gray-100 bg-white transition-all duration-500 ease-in-out",
          className,
        )}
        {...rest}
      >
